...
const ProductCard = ({product}) => {
    const { currrency, addToCart, removeFromCart, cartItems, navigate } = useAppContext();
            ...
            <div className="text-gray-500/60 text-sm">
                ...
                <div className="flex items-end justify-between mt-3">
                    <p className="md:text-xl text-base font-medium text-primary">
                        {currrency}${product.offerPrice}{" "} <span className="text-gray-500/60 md:text-sm text-xs line-through">{currrency}${product.price}</span>
                    </p>
