  ...
  return (
    <div className="relative">
      ...
      <div className="absolute inset-0 flex flex-col items-center md:items-start justify-end md:justify-center pb-24 md:pb-0 px-4 md:pl-18 lg:pl-24">
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-center mb-6 md:text-left max-w-72 md:max-w-80 lg:max-w-105 leading-tight lg:leading-15">
          Freshness You Can Trust, Saving You will Love!
        </h1>

        <div className="flex items-center mt-top font-medium">
          <Link
            to={"/products"}
